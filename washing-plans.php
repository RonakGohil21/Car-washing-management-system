...
<html lang="en">
    ...
    <body style="background-color:rgb(58, 88, 118);">
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (₹250)</option>
...
<?php } ?>
            ...
            <p>Wash Date <br /><input type="date" name="washdate" required class="form-control" min="<?php echo date('Y-m-d'); ?>"></p>
