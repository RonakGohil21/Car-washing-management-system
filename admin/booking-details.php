...
{				?>		
						  <tr>
						  	<th  style="background-color: rgb(58, 88, 118);"width="200">Booking Id</th>
							<td><?php echo htmlentities($result->bookingId);?></td>
							<th style="background-color: rgb(58, 88, 118)">Posting Date</th>
								<td><?php echo htmlentities($result->postingDate);?></td>
						</tr>
						<tr>
							<th style="background-color: rgb(58, 88, 118)">Name</th>
							<td width="300"><?php echo htmlentities($result->fullName);?></td>
							<th style="background-color: rgb(58, 88, 118)">Mobile No</th>
							<td><?php echo htmlentities($result->mobileNumber);?></td>
						</tr>
						<tr>
							<th style="background-color: rgb(58, 88, 118)">Package Type</th>
								<td>
...
if($ptype==3): echo "COMPLEX CLEANING (₹400)";endif;
						...
						<th style="background-color: rgb(58, 88, 118)">Washing Point</th>
							...
							<tr>
								<th style="background-color: rgb(58, 88, 118)">Washing Date</th>
							<td><?php echo htmlentities($result->washDate);?></td>
							<th style="background-color: rgb(58, 88, 118)">Washing Time</th>
							<td><?php echo htmlentities($result->washTime);?></td>
							</tr>
							<tr>
								<th style="background-color: rgb(58, 88, 118)">Message (if Any)</th>
<td colspan="3"><?php echo htmlentities($result->message);?></td>
							</tr>
							
					<tr>
								<th style="background-color: rgb(58, 88, 118)">Status</th>
